    ...
    return (
        <div className='md:flex-row aboutme flex flex-col h-max justify-evenly' id='aboutme'>
            ...
            <div className="m-auto md:m-auto md:w-[55%] my-[10px] sobre-mim w-[95%] flex items-center text-left p-[10px] rounded-[3px] text-[120%] font-medium bg-black-transparent">
                <p>Olá, me chamo Eduardo, tenho 22 anos e sou um jovem apaixonado por tecnologia e desenvolvimento, estou buscando entrar na área de programação para aprimorar minhas habilidades e contribuir para projetos maiores e mais desafiadores. Tenho facilidade de aprendizado, penso fora da caixa e estou sempre buscando novos desafios para me desenvolver profissionalmente.
                </p>
            </div>
        </div>
    );
