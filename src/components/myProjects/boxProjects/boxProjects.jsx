...
function BoxProjects(props) {
    ...
    return (
        <>
            <a className="flex flex-col items-center justify-evenly w-[100%] min-w-[300px] min-h-[570px] h-max rounded border-2 border-red-transparent cursor-pointer bg-black-transparent py-4 px-5 m-3" href={props.projectLink} target="_blank">
