        ...
        <div className="myprojects w-[100%] py-0 px-[20px]">
            <div className="flex flex-col">
                ...
                <div className="flex flex-col md:flex-row items-center justify-around my-[5px] mx-0">
                    <a className="dudureceitas projects md:w-[45%] w-[100%] md:my-0 my-[10px] sm:px-[20px] px-[10px] min-w-[300px] md:h-[570px] h-max" href="https://dudureceitas.surge.sh" target="_blank">
                    ...
                    <a className="ohanacestas projects md:w-[45%] w-[100%] md:my-0 my-[10px] sm:px-[20px] px-[10px] min-w-[300px] md:h-[570px] h-max" href="https://ohanacestas.com.br" target="_blank">
